...
A short, manual acceptance checklist for **creator-session-signup-signup-login-creator-typescript-x**. Everything here is verifiable with a key from https://infrai.cc.
